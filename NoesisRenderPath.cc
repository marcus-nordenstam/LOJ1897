  ...
  public:
    ...
    void CaptureFrameToMemory() {
        ...
        if (!renderResultPtr || !renderResultPtr->IsValid()) {
            wi::backlog::post("CaptureFrameToMemory: GetLastPostprocessRT invalid, trying GetRenderResult\n");
    ...
    void ProcessAndCreatePhotoCard() {
        ...
        if (!SaveProcessedPhoto(pendingPhotoFilename, pendingPhotoPixels, pendingPhotoWidth, pendingPhotoHeight)) {
    ...
    bool SaveProcessedPhoto(const std::string& filename, const std::vector<uint8_t> &pixels, int width, int height) {
    ...
    void AddPhotoCard(const std::string &photoFilename) {
        ...
        label->SetForeground(
            Noesis::MakePtr<Noesis::SolidColorBrush>(Noesis::Color(0x4A, 0x3C, 0x28)));
